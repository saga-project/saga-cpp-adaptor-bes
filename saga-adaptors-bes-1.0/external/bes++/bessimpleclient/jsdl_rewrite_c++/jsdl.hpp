...
{
  struct new_jsdl_bound lowerBound;
  struct new_jsdl_bound upperBound;
};
...
struct new_jsdl_range_value 
{
  struct new_jsdl_bound upperBoundedRange;
  struct new_jsdl_bound lowerBoundedRange;
  struct new_jsdl_exact exact;
  struct new_jsdl_range range;
};
...
struct jsdl_job_definition 
{
  ...
  struct new_jsdl_range_value     TotalCPUCount;
